...
public partial class Citizen_Citizen_registeration : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (txtpwd.Text == txtcnmpwd.Text)
        {
            ...
            SqlCmd = "Insert INTO Citizenregister(Username,Password,Firstname,Lastname,Email,Phone_No,Location)Values('" + txtuser.Text + "','" + txtpwd.Text + "','" + txtfname.Text + "','" + txtlname.Text + "','" + txtEmail.Text + "','" + txtphone.Text + "','" + txtlocation.Text + "')";
