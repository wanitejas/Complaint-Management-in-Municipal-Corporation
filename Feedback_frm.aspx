<%@ Page Title="" Language="C#" MasterPageFile="~/Main_master.master" AutoEventWireup="true" CodeFile="Feedback_frm.aspx.cs" Inherits="Feedback_frm" %>
...
<tr><td>NAME:</td><td class="style1">
    <asp:TextBox ID="TextBox1" runat="server" ontextchanged="TextBox1_TextChanged"></asp:TextBox></td></tr>
...
<tr><td>Address:</td><td class="style1">
    ...
    <tr><td>Feedback:</td><td class="style1">
